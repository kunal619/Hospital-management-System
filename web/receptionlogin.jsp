  ...
  <body><a href="index.html"><img src="logo.png" id="logo" height="47" width="100" style="margin-top:10px;margin-left:20px;"></img></a>
    ...
    <div class="overlay">
      <h1>Reception Login</h1>
        <form action="ReceptionLogin" method="get">
            <br><input type="text" name="rname" placeholder="Receptionist Name "><br>
            <input type="text" name="rid" placeholder="Receptionist ID"><br>
